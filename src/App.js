...
import CatalogRender from "./panels/components/CatalogRender/CatalogRender";
import RenderLiveHack from "./panels/components/RenderLiveHack/RenderLiveHack";
...
const App = () => {
	...
	return (
		<View activePanel={activePanel} popout={popout}>
			<RenderLiveHack liveHacks={LiveHacks} go={go}/>
			{ListLiveHack({listLiveHack: LiveHacks,  go})}
