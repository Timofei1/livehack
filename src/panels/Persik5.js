...
const Persik5 = props => (
    <Panel id={props.id}>
        ...
        <Group title='Ход выполнения'>
            <Div>
                <h>Включи на телефоне функцию автоматического принятия звонка и оставь его там, где это необходимо. В
                    нужное время просто нажми на вызов, и твоя разведка в действии! Речь не идет о серьезных операциях,
                    но такие шпионские штучки вполне могут заменить радионяню.
                </h>
