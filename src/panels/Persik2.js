...
const Persik2 = props => (
	<Panel id={props.id}>
		...
		<Div>
		<h>Все знают, что не нужно брать телефон в постель из-за синего излучения, которое мешает спать, но все равно берут. Если уж брать телефон, то с включенной темной темой или со специальным "режимом для чтения".</h>
		</Div>
		</Group>
    </Panel>
);
