...
const Persik3 = props => (
	<Panel id={props.id}>
	    ...
	    <h><br/>4. Как вы уже знаете, снаружи должно быть прохладно, а внутри, напротив, – тепло. Выпейте перед сном стакан теплого молока, какао или чая, и вам тот час же захочется спать.<br/></h>
	    <h><br/>5. Спать до обеда на выходных – это быстрый способ нарушить расписание сна на неделю. Вы можете себе позволить понежиться в постели, но не более чем часом больше от вашего привычного подъема. Если вы работаете эту привычку, то уже через неделю-две у вас исчезнут проблемы с сном.</h>
		</Div>
		</Group>
    </Panel>
);
