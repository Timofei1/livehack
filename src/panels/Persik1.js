...
const Persik1 = props => (
	<Panel id={props.id}>
		...
		<h><br/>5. 16-24ºС – такой должна быть температура в спальне. В душном и слишком жарком помещении человек часто просыпается и хуже засыпает.<br/></h>
		<h><br/>6. Спорт улучшает качество сна, однако заканчивать тренировку следует минимум за 2 часа до отбоя. Ведь физические упражнения насыщают организм не только кислородом, но и адреналином, а он плохое «снотворное».<br/></h>
	    <h><br/>7. Перед сном лучше провести, так называемую, мышечную релаксацию. Она заключается в том, чтобы поочередно напрягать и расслаблять различные группы мышц. Напрягли мышцы ног, досчитали до пяти, расслабились; напрягли пресс, один-два-три-четыре-пять, выдох и т.д. Эту процедуру можно проделывать прямо лежа в кровати. Кроме того, подготовить тело ко сну помогает медитация.<br/></h>
